          ...
          Row(
                   ...
                   Row(children: [
                     ...
                     border:  OutlineInputBorder(
                      ...
                      borderSide: BorderSide(color: AppColors.createevnt)
                          ...
                          hint: Text(DateFormat.yMd().format(selectedDate),
                          style: GoogleFonts.poppins(
                          fontWeight: FontWeight.w400,
                          fontSize: 14,color: AppColors.profilesetting),
                          ),
                       ...
                       setState(() {
                        ...
                        },  icon: Icon(Icons.date_range_sharp,color: AppColors.profilesetting,)),
                         ),
                       ),
                     ),
                     Gap(10),
            ...
            Column(children: [
              ...
              Container(
                ...
                child:
                 Row(children: [
                   Expanded(
                    ...
                    hint: Text(selectedTime.format(context).toString(),
                    style: GoogleFonts.poppins(
                    fontWeight: FontWeight.w400,
                    fontSize: 14,color: AppColors.profilesetting),
                    ),
                ...
                }, icon: Icon(Icons.access_time,color: AppColors.profilesetting))
                ),
              ),
            )
            ],),)
             ...
             Padding(
               ...
               child: Container(
                 ...
                 Padding(
                   ...
                   child: Text("Lorem ipsum dolor sit amet consectetur. Lectus viverra fermentum natoque nibh enim aliquam tincidunt eu purus. Non habitasse sed feugiat aliquet tortor. Risus turpis quam est quam leo turpis ipsum. Amet non sed lacus placerat turpis in. Vitae amet sit sed dictum eget scelerisque massa nibh.",
                   style: GoogleFonts.poppins(
                       fontWeight: FontWeight.w400,
                       fontSize: 14,color: AppColors.profilesetting
                   ),),
